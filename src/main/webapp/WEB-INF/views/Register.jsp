...
<script
	src="${pageContext.request.contextPath}/styles/js/RegisterAccount1.js"
	type="text/javascript"></script>
<head>
...
<jsp:include page="menu.jsp"></jsp:include>
	<div class="signup-form">
		<form:form method="post" modelAttribute="accountC">
			<h2>Register</h2>
			<p class="hint-text">Create your account. It's free and only
				takes a minute.</p>
			<div class="form-group">
				<input hidden="true" name="idCus" type="text"
					value="${accountC.idCus}">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<input name="re-password" type="password" class="form-control"
					name="confirm_password" placeholder="Confirm Password" id="repass">

			</div>
			<center>
				<p id="errorRepass" class="errorRepass"></p>
			</center>
			<div class="form-group">
			...
			<div class="form-group">
				<button type="submit" style="color: white; position: absolute; background-color: #fdd513; height: 40px; width: 170px; -moz-border-radius: 10px; -webkit-border-radius: 10px;margin-left: 80px; ">Register
					Now</button>
			</div>
			<br><br><br>
